...
type SuperAdminPage = "dashboard" | "barberias" | "usuarios" | "configuracion";
...
export default function SuperAdminLayout({
  ...
  const menuItems = [
    ...
    {
      name: "Configuración",
      path: "/admin/super/configuracion",
      id: "configuracion",
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="hidden md:block fixed left-0 top-0 w-64 bg-gray-800 text-white flex flex-col h-screen">
        <div className="p-4 flex-grow overflow-y-auto">
          <div className="mb-6 pb-4 border-b border-gray-700">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-purple-600 rounded-md flex items-center justify-center text-xl font-bold text-white mr-3">
                SA
              </div>
              <div>
      ...
      <div
        className="md:pl-64 p-4 md:p-8"
        style={{ paddingTop: actions ? "7rem" : "4rem" }}
      >
